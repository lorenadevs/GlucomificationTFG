...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [418 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
...
@.env.3 = private unnamed_addr constant [37 x i8] c"06c697b2-46d0-4cd3-abff-a2af2f4acb1b\00", align 1
...
@.DSOCacheEntry.6_name = private unnamed_addr constant [17 x i8] c"libmongocrypt.so\00", align 1
