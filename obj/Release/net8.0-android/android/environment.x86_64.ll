...
@dso_cache = dso_local local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.6_name, ; name: libmongocrypt.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [418 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
...
@.env.3 = private unnamed_addr constant [37 x i8] c"06c697b2-46d0-4cd3-abff-a2af2f4acb1b\00", align 16
...
@.DSOCacheEntry.6_name = private unnamed_addr constant [17 x i8] c"libmongocrypt.so\00", align 16
